...
SECRET_KEY = os.getenv("SECRET_KEY", "b2a6d7a5b3d2e9c1f8a7b3d4e8f6a2c1d9e8f7a6b5c4d3e2a1b9c8d7e6f5a4b3")
ALGORITHM = "HS256"
...
async def get_current_admin_user(current_user: models.User = Depends(get_current_active_user)):
    if current_user.role not in [models.Role.admin, models.Role.superuser]:
